...
<body>
        ...
        <header class="header_dasboard">
            <a class="header_link" href="#">
                ...
                if(!isset($_SESSION['usuario'])){
                    header('/bolsa-empleo-php/iaes-lgi-2021/db/loguot.php');
                }
    ...
    <div id="contenedor">
        ...
        <input id="usuario" required type="text" placeholder="Ingresa tu usuario" name="usuario">
        <div class="caja">
        ...
        <input id="password" required type="password" placeholder="Ingresa tu contraseña" name="password">
        <input id="passwordConfirm" required type="password" placeholder="Confirma tu contraseña" name="passwordConfirm">
